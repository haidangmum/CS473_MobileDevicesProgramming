...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        User user2 = new User("email1234@gmail.com", "456789");
        User user3 = new User("email123@gmail.com", "789456");
        User user4 = new User("email1@gmail.com", "147258");
        User user5 = new User("email23@gmail.com", "258369");
        userList.add(user1);
        userList.add(user2);
        userList.add(user3);
        userList.add(user4);
